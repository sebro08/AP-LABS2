...
import { FiArrowLeft, FiUser, FiMail, FiPhone, FiCreditCard, FiSave, FiAlertCircle, FiBox } from 'react-icons/fi';
...
const EditarPerfil = () => {
  ...
  return (
    <div className="editar-perfil-admin">
      <div className="editar-perfil-header">
        <button className="btn-back" onClick={() => navigate('/admin/perfil')}>
